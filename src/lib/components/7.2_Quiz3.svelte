	...
	<div class="content">
		...
		<div class="quiz-layout">
			...
			<div class="options">
				...
				<button 
					class="option-box" 
					class:incorrect={selectedOption === 'Calligraphy'}
				...
				<button 
					class="option-box" 
					class:correct={selectedOption === 'Typography'}
		...
		<div class="modal-overlay" on:click={() => showModal = false}>
			<div class="modal-box" on:click|stopPropagation>
				...
				<div class="modal-buttons">
					...
					{/if}
					<button class="modal-button" on:click={handleRestart}>restart</button>
				</div>
			</div>
		</div>
	{/if}
